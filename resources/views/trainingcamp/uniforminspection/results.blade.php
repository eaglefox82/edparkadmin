<x-app-layout>
    <x-slot name="header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Uniform Inspection Results ({{ $event->name }})</h1>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </x-slot>
                ...
                @foreach($results as $mem)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('trainingcamp.uniforminspection.result.delete', ['eventId' => $event->id, 'memberId' => $mem->id]) }}"
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table id="unitData" class="table table-bordered table-striped">
                <thead>
                <tr>
                    <th class="text-center">Unit</th>
                    <th class="text-center">Members Inspected</th>
                    <th class="text-center">Avg Points Lost</th>
                </tr>
                </thead>
                <tbody>
        ...
        <script>
            $(function () {
                ...
                $("#unitData").DataTable({
                    ...
                    "paging": false,
                    "order": [[0, 'asc']]
                }).buttons().container().appendTo('#unitData_wrapper .col-md-6:eq(0)');
