            ...
            <div class="card-tools">
                <ul class="pagination float-right">
                    <li class="page-item">
                        <a class="page-link"
                           target="_blank"
                           href="{{ route('recreationcamp.accommodation.print.single', ['eventId' => $event->id, 'roomId' => $room->id]) }}">Print Room Roll</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                @foreach($room->members() as $attendance)
                    <tr>
                        <td class="text-center">
                            <a href="{{ route('recreationcamp.members.view', ['eventId' => $event->id, 'registrationId' => $attendance->id]) }}" class="btn btn-info">View</a>
                        </td>
